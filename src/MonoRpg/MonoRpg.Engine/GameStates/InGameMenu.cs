namespace MonoRpg.Engine.GameStates {
    ...
    public class FrontMenu : State, IStateObject {
        ...
        public override void Render(Renderer renderer) {
            ...
            renderer.DrawText2D(goldX+10, goldY, "0", Color.White, scale);
            renderer.DrawText2D(goldX+10, goldY-25, "0", Color.White, scale);
